...
function changeTimeFormat() {
  ...
  document
    .getElementById("time")
    .setAttribute("data-format", timeFormat.textContent);
  // Save time format
...
function displayBookmarksEditor() {
  ...
  const bookmarksEditor = document.getElementById(
    "settings-bookmarks-edit"
  ).parentElement;
...
function saveBookmarksEditor() {
  ...
  try {
    ...
    console.error(
      "Error parsing bookmarks at line " +
        errorLine +
        ", character " +
        errorChar +
        ": " +
...
function displayNewsEditor() {
  // Get news editor
  const newsEditor =
    document.getElementById("settings-news-edit").parentElement;
  // Fill news editor
  fillNewsEditor();
  // Toggle open class
...
function exportSettings() {
  ...
  // Set href
  element.href =
    "data:application/json;charset=utf-8," + encodeURIComponent(settingsStr);
  // Set download
...
function switchTime() {
  ...
  const switchSearch = document.getElementById(
