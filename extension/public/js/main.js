...
function init() {
  ...
  if (searchStatus && searchStatus != "null") {
    document.getElementById("settings-search-switch").checked =
      searchStatus == "true";
    switchSearch();
  } else {
  ...
  if (timeStatus && timeStatus != "null") {
    document.getElementById("settings-time-switch").checked =
      timeStatus == "true";
    switchTime();
  }
  // Set time format
  ...
  if (bookmarksStatus && bookmarksStatus != "null") {
    document.getElementById("settings-bookmarks-switch").checked =
      bookmarksStatus == "true";
    switchBookmarks();
  }
  // Set news
  if (news && news != "null") {
  ...
  if (newsStatus && newsStatus != "null") {
    document.getElementById("settings-news-switch").checked =
      newsStatus == "true";
    switchNews();
  }
  // Init CORS
